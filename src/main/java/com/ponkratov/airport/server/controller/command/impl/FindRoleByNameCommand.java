...
public class FindRoleByNameCommand implements ActionCommand {
    ...
    public CommandResult execute(Map<String, String> params) throws JsonProcessingException {
        ...
        String roleName = params.get(RequestAttribute.ROLENAME);
        try {
            Optional<Role> result = service.findByRoleName(roleName);
            if (result.isPresent()) {
            ...
            LOG.error("Failed to execute FindRoleByNameCommand", e);
